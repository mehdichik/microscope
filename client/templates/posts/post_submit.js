...
var errors = validatePost(post); if (errors.title || errors.url)
...
Template.postSubmit.created = function() { Session.set('postSubmitErrors', {});
}
Template.postSubmit.helpers({ errorMessage: function(field) {
